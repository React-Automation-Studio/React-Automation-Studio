...
class SteererYMagnet extends React.Component {
  constructor(props) {
    ...
    pvs['OffOn']={initialized: false, pvname:'pva://'+props.system.devices.device.deviceName+":put-offOn",value:"",char_value:"",metadata:{}};
    pvs['StatusText']={initialized: false, pvname:'pva://'+props.system.devices.device.deviceName+":get-statusText",value:"",char_value:"",metadata:{}};
    pvs['LocalRemote']={initialized: false, pvname:'pva://'+props.system.devices.device.deviceName+":get-localRemote",value:"",char_value:"",metadata:{}};
  ...
  render() {
    ...
    const initialized=pvs.readback.initialized&&pvs.OffOn.initialized&&pvs.StatusText.initialized&&pvs.LocalRemote.initialized;
    ...
    let severity=0;
    if((pvs.OffOn.value==1)){
    if ((pvs.StatusText.value=="Fault")){
      severity=2;
    }
    else if((pvs.LocalRemote.value=="Local"))  {
      severity=1;
    }
  }
  ...
  //  console.log(readbackValue);
    ...
    return (
      <g  onClick={this.handleOnClick(this.props.system)}>
        ...
        <DataConnection
          pv={this.state.pvs['OffOn'].pvname}

          handleInputValue={this.handleInputValue('OffOn')}
          handleMetadata={this.handleMetadata('OffOn')}
        />
        <DataConnection
          pv={this.state.pvs['StatusText'].pvname}
          usePrecision={usePrecision}
          handleInputValue={this.handleInputValue('StatusText')}
          handleMetadata={this.handleMetadata('StatusText')}
          useStringValue={true}
        />
        <DataConnection
          pv={this.state.pvs['LocalRemote'].pvname}
          usePrecision={usePrecision}
          handleInputValue={this.handleInputValue('LocalRemote')}
          handleMetadata={this.handleMetadata('LocalRemote')}
          useStringValue={true}
        />
