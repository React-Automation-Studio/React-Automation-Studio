...
handleOnClick =device=> (event) => {
  ...
  //        console.log("pvs['safetyAlarmPV'].value",pvs['safetyAlarmPV'].value)
          ...
          /*      const safetyAlarmPV='pva://'+this.props.systemName+':get-status.B0';
          const airPressurePV='pva://'+this.props.systemName+':get-status.B2';
          const opActInPV='pva://'+this.props.systemName+':get-status.B3';
          const HvPV='pva://'+this.props.systemName+':get-status.B4';
          const movingPV='pva://'+this.props.systemName+':get-status.B5';
          const inPV='pva://'+this.props.systemName+':get-status.B6';
          const outPV='pva://'+this.props.systemName+':get-status.B7';
          const statusPV='pva://'+this.props.systemName+':get-statusText';
          const commandPV='pva://'+this.props.systemName+':put-outIn';
          */
          /*      const status= this.state.pvs['statusPV'].value;
          ...
          case 'In':
          yoffset=0;
          alarmColor=color='#133C99';
          break;
          case 'DangerIn':
          yoffset=0;
          alarmColor=color='#E20101';
          break;
          ...
          case 'Invalid':
          yoffset=-30;
          alarmColor=color='#f900e5';
          break;

          case 'Moving':
          yoffset=-30;
          alarmColor=color='#f9e500';
          break;
        ...
        */
        /*
        let yoffset=0;
        if (this.state.pvs['statusPV'].value==='In')(this.state.pvs['statusPV'].value==='In'){
...
Harp 5P
FC2sim
0 ADataConnection pv={this.state.pvs['safetyOkPV'].pvname} handleInputValue={this.handleInputValue('safetyOkPV')} />
...
Harp 6P
    ...
    */
     ...
     console.log(this.state.pvs['statusPV']);
    //  console.log(this.state.pvs['commandPV'].value);
    return (
      <g>
        <Dialog
            ...
            {(initialized===false||initialized==='undefined') &&
              <g>
                ...
                <text
                  ...
                  y={this.props.cy+60}
                  textAnchor='middle'
                  filter={"url(#"+this.props.systemName+"FCShadow)" }
                >
                  {"Connecting"}
                </text>
                <text
