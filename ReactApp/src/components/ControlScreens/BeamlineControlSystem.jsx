  ...
  const footerContents = (
    ...
    >
      <Grid item xs={12} style={{ paddingLeft: "1em" }}>
        <Typography>
          All the components are now reusable hooks components. See the style
          guide Beamline Components section for more details!
        </Typography>
      </Grid>
    </Grid>
  );
                    ...
                    <Grid item sm={6}>
                      ...
                      >
                        <GraphY
                          ...
                          maxLength={600}
                          legend={["Q1 readback", "Q2 readback", "Q3 readback"]}
                          yUnits={" A"}
                          useTimeStamp={true}
                          usePolling={true}
                          pollingRate={100}
                    ...
                    <Grid item sm={6}>
                      ...
                      >
                        <GraphY
                          ...
                          usePolling={true}
                          pollingRate={100}
                          legend={["Q1 setpoint", "Q2 setpoint", "Q3 setpoint"]}
                          yUnits={" A"}
                          useTimeStamp={true}
                        />
                      </div>
