...
const TextInputHooksComponent=(props)=> {
...
/**
 * The TextInputHooks Component is a wrapper on the Material-UI contained TextField component.
 ...
 * 
 */
const TextInputHooks =(props)=>{
    return (
      <Widget {...props} component={TextInputHooksComponent}/>
    )
}

TextInputHooks.propTypes = {
...
export default withStyles(styles, { withTheme: true })(TextInputHooks);
