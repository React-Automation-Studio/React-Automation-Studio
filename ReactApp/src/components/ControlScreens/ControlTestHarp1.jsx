...
class ControlTestHarp1 extends React.Component {
  constructor(props) {
    ...
    this.handleHarpInsertedOrRemoved =
      this.handleHarpInsertedOrRemoved.bind(this);
                    ...
                    <Grid item sm={12}>
                      ...
                      >
                        <Grid item sm={2}>
                          ...
                          >
                            {typeof this.state.x0SystemName !== "undefined" && (
                              <React.Fragment>
                                <HarpRangeSelection
                                  onlyX={this.state.onlyX0}
                                  onlyY={this.state.onlyY0}
                                  key={
                                    "harpRangeSelectionx0" +
                                    this.state.x0SystemName
                                  }
                                  systemName={this.state.x0SystemName}
                                  label={"Range"}
                                />
                                <div style={{ marginBottom: 8 }}>
                                  {this.state.onlyY0 === false &&
                                    this.state.onlyX0 === false && (
                                      <ActionButton
                                        key={
                                          "storex0" + this.state.x0SystemName
                                        }
                                        pvs={[
                                          "$(device):x_store_offset",
                                          "$(device):y_store_offset",
                                        ]}
                                        macros={{
                                          "$(device)": this.state.x0SystemName,
                                        }}
                                        actionValue={"1"}
                                        actionString={"Store Offset"}
                                      />
                                    )}
                                  {this.state.onlyY0 === true &&
                                    this.state.onlyX0 === false && (
                                      <ActionButton
                                        key={
                                          "storex0" + this.state.x0SystemName
                                        }
                                        pvs={["$(device):y_store_offset"]}
                                        macros={{
                                          "$(device)": this.state.x0SystemName,
                                        }}
                                        actionValue={"1"}
                                  ...
                                  {this.state.onlyY0 === false &&
                                    this.state.onlyX0 === true && (
                                      <ActionButton
                                        key={
                                          "storex0" + this.state.x0SystemName
                                        }
                                        pvs={["$(device):x_store_offset"]}
                                        macros={{
                                          "$(device)": this.state.x0SystemName,
                                        }}
                                        actionValue={"1"}
                                ...
                                <div style={{ marginBottom: 8 }}>
                                  {this.state.onlyY0 === false &&
                                    this.state.onlyX0 === false && (
                                      <ActionButton
                                        key={
                                          "clearx0" + this.state.x0SystemName
                                        }
                                        pvs={[
                                          "$(device):x_store_offset",
                                          "$(device):y_store_offset",
                          ...
                          >
                            <Grid item sm={6}>
                              <div style={{ height: "30vh" }}>
                                {this.state.onlyY0 === false &&
                                  this.state.x0GraphPVs.length > 0 && (
                                    <HarpGraph
                                      ymax={2000}
                                      units={"pA"}
                                      ...
                                      changeOtherGraphYmax={
                                        this.changeTopYgraphYmax
                                      }
                                      ymaxFromOtherGraph={
                                        this.state.TopXgraphYmax
                                      }
                                      ylabel="X Axis"
                                    />
                                  )}
                            ...
                            <Grid item sm={6}>
                              <div style={{ height: "30vh" }}>
                                {this.state.onlyX0 === false &&
                                  this.state.y0GraphPVs.length > 0 && (
                                    <HarpGraph
                                      ymax={2000}
                                      units={"pA"}
                                      ...
                                      changeOtherGraphYmax={
                                        this.changeTopXgraphYmax
                                      }
                                      ymaxFromOtherGraph={
                                        this.state.TopYgraphYmax
                                      }
                                      ylabel="Y Axis"
                                    />
                                  )}
                      ...
                      <div style={{ height: "30vh" }}>
                        ...
                        >
                          <Grid item sm={2}>
                            ...
                            >
                              {typeof this.state.x1SystemName !==
                                "undefined" && (
                                <React.Fragment>
                                  <HarpRangeSelection
                                    onlyX={this.state.onlyX1}
                                    onlyY={this.state.onlyY1}
                                    key={
                                      "harpRangeSelectionx1" +
                                      this.state.x1SystemName
                                    }
                                    systemName={this.state.x1SystemName}
                                    label={"Range"}
                                  />
                                  <div style={{ marginBottom: 8 }}>
                                    {this.state.onlyY1 === false &&
                                      this.state.onlyX1 === false && (
                                        <ActionButton
                                          key={
                                            "storex1" + this.state.x1SystemName
                                          }
                                          pvs={[
                                            "$(device):x_store_offset",
                                            "$(device):y_store_offset",
                                  ...
                                  <div style={{ marginBottom: 8 }}>
                                    {this.state.onlyY1 === false &&
                                      this.state.onlyX1 === false && (
                                        <ActionButton
                                          key={
                                            "clearx1" + this.state.x1SystemName
                                          }
                                          pvs={[
                                            "$(device):x_store_offset",
                                            "$(device):y_store_offset",
                            ...
                            >
                              ...
                              >
                                <Grid item sm={6}>
                                  <div style={{ height: "30vh" }}>
                                    {this.state.onlyY1 === false &&
                                      this.state.x1GraphPVs.length > 0 && (
                                        <HarpGraph
                                          ymax={2000}
                                          units={"pA"}
                                          ...
                                          ylabel="X Axis"
                                          changeOtherGraphYmax={
                                            this.changeBottomYgraphYmax
                                          }
                                          ymaxFromOtherGraph={
                                            this.state.BottomXgraphYmax
                                          }
                                        />
                                      )}
                                  </div>
                                ...
                                <Grid item sm={6}>
                                  <div style={{ height: "30vh" }}>
                                    {this.state.onlyX1 === false &&
                                      this.state.y1GraphPVs.length > 0 && (
                                        <HarpGraph
                                          ymax={2000}
                                          units={"pA"}
                                          ...
                                          ylabel="Y Axis"
                                          changeOtherGraphYmax={
                                            this.changeBottomXgraphYmax
                                          }
                                          ymaxFromOtherGraph={
                                            this.state.BottomYgraphYmax
                                          }
                                        />
                                      )}
                                  </div>
