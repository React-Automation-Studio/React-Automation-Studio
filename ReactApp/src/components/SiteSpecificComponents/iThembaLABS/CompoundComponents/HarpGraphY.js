...
const wireLabels = ["-42", "", "", "", -30, "", "","", -20, "", "","","", -10, "","", "", "","", "","", "", "",                0, "","" ,"","","","", "","", "", 10, "", "", "", "", 20, "", "", "", 30,  "", "", "",42,"" ];
...
/**
* The HarpGraphY Component has been updated to Plotly.js scatter and line plot. **Note**: The update includes a small breaking change. See the backgroundColor prop for the workaround. 

*/

const HarpGraphY = (props) => {
  ...
  const yAxes = useCallback(() => {
    ...
    // }
    return (yAxesInit)
  },[ props.yUnits,props.yNoOfTicks,props.yMin,props.yMax,props.yScaleLog10,props.yTickFormat,theme.palette.reactVis])
  ...
  return (
    ...
    style={{ width: props.width ? props.width : width, height: props.height ? props.height : height, backgroundColor: backgroundColor }}
