...
ADMIN_DATABASE_REPLICA_SET_NAME=os.getenv('ADMIN_DATABASE_REPLICA_SET_NAME')
if (ADMIN_DATABASE is None) :
    ...
    if (ADMIN_DATABASE_REPLICA_SET_NAME is None) :
        print("Enviroment variable ADMIN_DATABASE_REPLICA_SET_NAME is not defined, can't intialize: ",MONGO_INITDB_ADMIN_DATABASE)
    else:
        ADMIN_DATABASE_REPLICA_SET_NAME=str(ADMIN_DATABASE_REPLICA_SET_NAME)
        if (mongoAuth):
