...
/**
* The GraphYV2 Component is a wrapper on Uber's React-Vis FlexibleXYPlot lineSeries graph component. The GraphYV2 component is implemented with zero margins and enabled to grow to the width and height of its parent container.<br/><br/>
...
*/
// class GraphYV2 extends React.Component {
//   constructor(props) {
//     super(props);
//     let state={}
//     let pv;
