  ...
  useEffect(() => {
    ...
    for (harp in harpPvs) {
      if (harpPvs[harp]) {
        ...
        let systemName = replaceMacros(
          currentHarp.systemName,
          currentHarp.macros
        );
            ...
            <Grid item sm={2}>
              ...
              >
                {harpGraphsState.x0SystemName !== undefined && (
                  <React.Fragment>
                    <HarpRangeSelection
                      onlyX={harpGraphsState.onlyX0}
                      onlyY={harpGraphsState.onlyY0}
                      key={
                        "harpRangeSelectionx0" + harpGraphsState.x0SystemName
                      }
                      systemName={harpGraphsState.x0SystemName}
                      label={"Range"}
                    />
                    <div style={{ marginBottom: 8 }}>
                      {harpGraphsState.onlyY0 === false &&
                        harpGraphsState.onlyX0 === false && (
                          <ActionButton
                            key={"storex0" + harpGraphsState.x0SystemName}
                            pvs={[
                              "$(device):x_store_offset",
                              "$(device):y_store_offset",
                            ]}
                            macros={{
                              "$(device)": harpGraphsState.x0SystemName,
                            }}
                            actionValue={"1"}
                            actionString={"Store Offset"}
                          />
                        )}
                      {harpGraphsState.onlyY0 === true &&
                        harpGraphsState.onlyX0 === false && (
                          <ActionButton
                            key={"storex0" + harpGraphsState.x0SystemName}
                    ...
                    <div style={{ marginBottom: 8 }}>
                      {harpGraphsState.onlyY0 === false &&
                        harpGraphsState.onlyX0 === false && (
                          <ActionButton
                            key={"clearx0" + harpGraphsState.x0SystemName}
                            pvs={[
                              "$(device):x_store_offset",
                              "$(device):y_store_offset",
                            ]}
              ...
              >
                <Grid item sm={6}>
                  <div style={{ height: "25vh" }}>
                    {harpGraphsState.onlyY0 === false &&
                      harpGraphsState.x0GraphPVs.length > 0 && (
                        <HarpGraph
                          ymax={2000}
                          units={"pA"}
                ...
                <Grid item sm={6}>
                  <div style={{ height: "25vh" }}>
                    {harpGraphsState.onlyX0 === false &&
                      harpGraphsState.y0GraphPVs.length > 0 && (
                        <HarpGraph
                          ymax={2000}
                          units={"pA"}
              ...
              <Grid item sm={2}>
                ...
                >
                  {harpGraphsState.x1SystemName !== undefined && (
                    <React.Fragment>
                      <HarpRangeSelection
                        onlyX={harpGraphsState.onlyX1}
                        onlyY={harpGraphsState.onlyY1}
                        key={
                          "harpRangeSelectionx1" + harpGraphsState.x1SystemName
                        }
                        systemName={harpGraphsState.x1SystemName}
                        label={"Range"}
                      />
                      <div style={{ marginBottom: 8 }}>
                        {harpGraphsState.onlyY1 === false &&
                          harpGraphsState.onlyX1 === false && (
                            <ActionButton
                              key={"storex1" + harpGraphsState.x1SystemName}
                              pvs={[
                                "$(device):x_store_offset",
                                "$(device):y_store_offset",
                              ]}
                              macros={{
                                "$(device)": harpGraphsState.x1SystemName,
                              }}
                              actionValue={"1"}
                              actionString={"Store Offset"}
                            />
                          )}
                        {harpGraphsState.onlyY1 === true &&
                          harpGraphsState.onlyX1 === false && (
                            <ActionButton
                              key={"storex1" + harpGraphsState.x1SystemName}
                              pvs={["$(device):y_store_offset"]}
                      ...
                      <div style={{ marginBottom: 8 }}>
                        {harpGraphsState.onlyY1 === false &&
                          harpGraphsState.onlyX1 === false && (
                            <ActionButton
                              key={"clearx1" + harpGraphsState.x1SystemName}
                              pvs={[
                                "$(device):x_store_offset",
                                "$(device):y_store_offset",
                              ]}
                ...
                >
                  ...
                  >
                    <Grid item sm={6}>
                      <div style={{ height: "25vh" }}>
                        {harpGraphsState.onlyY1 === false &&
                          harpGraphsState.x1GraphPVs.length > 0 && (
                            <HarpGraph
                              ymax={2000}
                              units={"pA"}
                    ...
                    <Grid item sm={6}>
                      <div style={{ height: "25vh" }}>
                        {harpGraphsState.onlyX1 === false &&
                          harpGraphsState.y1GraphPVs.length > 0 && (
                            <HarpGraph
                              ymax={2000}
                              units={"pA"}
