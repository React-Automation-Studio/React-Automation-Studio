...
export const useLocalPV = (props) => {
  ...
  let contextPv = context.localVariables[pv.pvname]
    ? context.localVariables[pv.pvname]
    : undefined;
  ...
  useEffect(() => {
    if (typeof context.localVariables[pv.pvname] === "undefined") {
      let msg = {
        value:
          typeof props.initialLocalVariableValue === "undefined"
            ? 0
            : props.initialLocalVariableValue,
        connected: "1",
        newmetadata: "True",
        pvname: pv.pvname,
        char_value:
