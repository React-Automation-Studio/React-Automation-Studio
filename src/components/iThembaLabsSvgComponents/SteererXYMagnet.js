...
class SteererXYMagnet extends React.Component {
  constructor(props) {
    ...
    pvs['xOffOn']={initialized: false, pvname:'pva://'+props.system.devices.xDevice.deviceName+":put-offOn",value:"",char_value:"",metadata:{}};
    pvs['xStatusText']={initialized: false, pvname:'pva://'+props.system.devices.xDevice.deviceName+":get-statusText",value:"",char_value:"",metadata:{}};
    pvs['xLocalRemote']={initialized: false, pvname:'pva://'+props.system.devices.xDevice.deviceName+":get-localRemote",value:"",char_value:"",metadata:{}};
    pvs['yOffOn']={initialized: false, pvname:'pva://'+props.system.devices.yDevice.deviceName+":put-offOn",value:"",char_value:"",metadata:{}};
    pvs['yStatusText']={initialized: false, pvname:'pva://'+props.system.devices.yDevice.deviceName+":get-statusText",value:"",char_value:"",metadata:{}};
    pvs['yLocalRemote']={initialized: false, pvname:'pva://'+props.system.devices.yDevice.deviceName+":get-localRemote",value:"",char_value:"",metadata:{}};
    this.state={
      pvs:pvs
    }
  //  console.log(pvs);
  ...
  render() {
    ...
    let xUnits="";
    let yUnits="";
    const initialized=pvs.xReadback.initialized&&pvs.yReadback.initialized&&pvs.xOffOn.initialized&&pvs.xStatusText.initialized&&pvs.xLocalRemote.initialized&&pvs.yOffOn.initialized&&pvs.yStatusText.initialized&&pvs.yLocalRemote.initialized;
    ...
    if ((pvs.xStatusText.value=="Fault")||(pvs.yStatusText.value=="Fault")){
      severity=2;
    }
    else if((pvs.xLocalRemote.value=="Local")||(pvs.yLocalRemote.value=="Local"))  {
      severity=1;
    }
  }
  ...
  //  console.log(xReadbackValue);
  //  console.log(yReadbackValue);
    ...
    return (
      <g  onClick={this.handleOnClick(this.props.system)}>
        ...
        />
        <DataConnection
          pv={this.state.pvs['xOffOn'].pvname}

          handleInputValue={this.handleInputValue('xOffOn')}
          handleMetadata={this.handleMetadata('xOffOn')}
        />
        <DataConnection
          pv={this.state.pvs['xStatusText'].pvname}
          usePrecision={usePrecision}
          handleInputValue={this.handleInputValue('xStatusText')}
          handleMetadata={this.handleMetadata('xStatusText')}
          useStringValue={true}
        />
        <DataConnection
          pv={this.state.pvs['xLocalRemote'].pvname}
          usePrecision={usePrecision}
          handleInputValue={this.handleInputValue('xLocalRemote')}
          handleMetadata={this.handleMetadata('xLocalRemote')}
          useStringValue={true}
        />
        <DataConnection
          pv={this.state.pvs['yOffOn'].pvname}

          handleInputValue={this.handleInputValue('yOffOn')}
          handleMetadata={this.handleMetadata('yOffOn')}
        />
        <DataConnection
          pv={this.state.pvs['yStatusText'].pvname}
          usePrecision={usePrecision}
          handleInputValue={this.handleInputValue('yStatusText')}
          handleMetadata={this.handleMetadata('yStatusText')}
          useStringValue={true}
        />
        <DataConnection
          pv={this.state.pvs['yLocalRemote'].pvname}
          usePrecision={usePrecision}
          handleInputValue={this.handleInputValue('yLocalRemote')}
          handleMetadata={this.handleMetadata('yLocalRemote')}
          useStringValue={true}
        />
        {initialized===true &&
