...
import IsPrinting from '../SystemComponents/IsPrinting';
const styles = theme => ({
  root: {
    flexGrow: 1,
...
handlePrinting(printing){
  console.log(printing)
  //this.setState({printmode:printing});
            ...
            <div>
              ...
              <div >
                ...
                <Grid container spacing={3}>
                  ...
                  {notPrinting&&<Grid item xs={1}>

                    <SideBar/>
                  </Grid>}

                    {notPrinting&&<Grid item xs={11} >
                  ...
                  <Grid item xs={notPrinting===true?10:12}>
                    ...
                    <Grid
                      ...
                      >
                          {notPrinting&&<Grid item xs={2} >
                          <Box display="div" displayPrint="none">
                        ...
                        <Grid item xs={notPrinting===true?10:12}>
                          <Grid
                            ...
                            >
                              <Grid item xs={6}>
                                <div style={{height:notPrinting===true?'32.5vh':'50vh'}}>
