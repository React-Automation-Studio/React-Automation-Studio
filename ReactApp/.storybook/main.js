...
export default {
  ...
  '../src/docs/alarmHandler/alarmHandlerTop.mdx',
  ...
  '../src/docs/alarmHandler/alarmSetupMDX.mdx',
  '../src/docs/alarmHandler/alarmAreas.mdx',
  '../src/docs/alarmHandler/alarmTable.mdx',
  '../src/docs/alarmHandler/alarmLog.mdx',
  '../src/docs/alarmHandler/userNotificationMDX.mdx',
  '../src/docs/alarmHandler/alarmUserTable.mdx',
  '../src/docs/alarmHandler/filterPvList.mdx',
  '../src/components/LoadSaveComponent/LoadSave.mdx',
  '../src/components/ArchiverDataViewer/ArchiverDataViewer.mdx',
  // '../src/components/AlarmHandler/AlarmHandler.stories.tsx',
  // '../src/**/**/*.stories.@(js|jsx|mjs|ts|tsx)',
  '../src/**/**/**/*.stories.@(js|jsx|mjs|ts|tsx)',
